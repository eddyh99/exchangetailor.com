    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    <div class="col-12 col-md-8 mb-5 text-start mx-auto">
                        <h2 class="fw-bold title-top-header">Receive funds in 10 currencies</h2>
                        <h2 class="fw-bold subtitle-top-header">We make money work <br>
                            in your favor</h2>
                        <div class="my-3">
                            <p>
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    <div class="col-12 col-md-8 mb-5 text-start mx-auto">
                        <h2 class="title-top-header fw-bold">Convert, custody and send worldwide in over 50 currencies
                        </h2>
                        ...
                        <div class="my-3 content-freedy text-start">
                            <p>From your multi-currency wallet you can instantly convert one of your FIAT balances into
                                ...
                                and easily. MoneyPort offers the best exchange rates you can find on the market and the
                                absence of fees.</p>
                            <ul class="p-0">
